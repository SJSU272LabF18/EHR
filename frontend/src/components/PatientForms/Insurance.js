                        ...
                        <form role="form">
                            <div className="col-md-12">
                                <div class=" form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control right-border-none" placeholder="Insurance Name" type="text" name="insuranceName" onChange={this.insuranceNameHandler} defaultValue={this.state.insuranceName} />
                            ...
                            <div className="col-md-12">  
                                ...
                                <div class=" form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon "><span class="glyphicon glyphicon-user"></span></span>
                                        <input class="form-control right-border-none" placeholder="Subscriber ID" type="text" name="subscriberId" onChange={this.subscriberIdHandler} defaultValue={this.state.subscriberId} />
                                        <span class="input-group-addon transparent"><i class="fa fa-microphone icon-size"></i></span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class=" form-group col-md-12">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon "><span class="fa fa-address-card"></span></span>
                                        <input class="form-control right-border-none" placeholder="Employer Name and Address" type="text" name="emplName" onChange={this.emplNameHandler} defaultValue={this.state.emplName} />
                                        <span class="input-group-addon transparent"><i class="fa fa-microphone icon-size"></i></span>
                                    </div>
                                </div>
                                </div>
