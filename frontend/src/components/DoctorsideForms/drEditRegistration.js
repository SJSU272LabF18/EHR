...
class DrEditRegistration extends Component {
    constructor(props) {
        super(props);
        this.state = {
            fName:"",
            ...
            .then(response => {
                ...
                if (response.status === 200) {
                    this.props.history.push({
                        pathname: "/doctor/edit/emergency-contact",
                        state: {
                            email: this.props.location.state.email
                        }
                    })
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <div className="col-md-3">
                                <button style={{marginTop:"20px"}}type="submit" className="btn btn-success btn-lg">Next</button>
                            </div>
                            </div>
...
export default DrEditRegistration;
